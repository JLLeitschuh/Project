...
open class Validator {
    ...
    fileprivate var successStyleTransform:((validationRule:ValidationRule)->Void)?
    /// Variable that holds error closure to display negative status of field.
    fileprivate var errorStyleTransform:((validationError:ValidationError)->Void)?
    ...
    */
    ...
    - returns: No return value.
    */
    open func validateField(_ field: ValidatableField, callback: (error:ValidationError?) -> Void){
    ...
    - returns: No return value
    */
    open func styleTransformers(success:((validationRule:ValidationRule)->Void)?, error:((validationError:ValidationError)->Void)?) {
    ...
    /**
     ...
     - returns: No return value.
     */
    open func validate(_ callback:(errors:[(Validatable, ValidationError)])->Void) -> Void {
